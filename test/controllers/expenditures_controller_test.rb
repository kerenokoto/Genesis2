...
class ExpendituresControllerTest < ActionController::TestCase
  ...
  test "should create expenditure" do
    assert_difference('Expenditure.count') do
      post :create, expenditure: { date: @expenditure.date, maintenance: @expenditure.maintenance, salary: @expenditure.salary, total_expenditure: @expenditure.total_expenditure, utility_bills: @expenditure.utility_bills }
    end
  ...
  test "should update expenditure" do
    patch :update, id: @expenditure, expenditure: { date: @expenditure.date, maintenance: @expenditure.maintenance, salary: @expenditure.salary, total_expenditure: @expenditure.total_expenditure, utility_bills: @expenditure.utility_bills }
    assert_redirected_to expenditure_path(assigns(:expenditure))
  end
